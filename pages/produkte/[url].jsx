                    ...
                    <ListGroup variant="flush">
                        ...
                        <ListGroupItem>
                            ...
                            {produkt.extras.map((extra) => (
                                <span key={extra._id}>
                                    {extra.text + " " + extra.preis + "€" + ""}  <input className="form-check-input me-2" type="checkbox" id={extra.text} onChange={(e) => addExtra(e, extra)}/>
                                </span>
                            ))}
                        </ListGroupItem>
                        <ListGroupItem>
                            <input className="form-control w-50" type="number" value={menge} min="1" max="69" onChange={(e) => setMenge(e.target.value)}></input>
                        </ListGroupItem>
                        <ListGroupItem>
